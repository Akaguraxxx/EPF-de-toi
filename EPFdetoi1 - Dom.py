...
def Depart() : 
    ...
    frame_depart = Frame(fenetre1, bd=250, bg="pink", cursor = "heart")
    ...
    choix_sexe= Radiobutton(frame_depart, text="Sexe du personnage", bg="pink", variable=var_choix, value="Sexe") 
...
fenetre1 = Tk()
fenetre1.title("♥ ♥ ♥ ♥ ♥ ♥ ♥ ♥   Jeu EPF de toi  ♥ ♥ ♥ ♥ ♥ ♥ ♥ ♥") #, fg='navy')
...
Bouton_quitter=Button(fenetre1, text="Fermer la fenêtre",bg='pink', fg='navy', command=fenetre1.destroy)
